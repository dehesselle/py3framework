...
#set_rpath $PY3_FRA_LIB_DIR/python$PY3_MAJOR.$PY3_MINOR/lib-dynload/readline.cpython-$PY3_MAJOR${PY3_MINOR}m-darwin.so
...
#install_name_tool -add_rpath @executable_path/../Libraries $PY3_FRA_BIN_DIR/python$PY3_MAJOR.$PY3_MINOR

#install_name_tool -add_rpath @executable_path/.. $PY3_FRA_BIN_DIR/python$PY3_MAJOR.${PY3_MINOR}m
#install_name_tool -add_rpath @executable_path/../Libraries $PY3_FRA_BIN_DIR/python$PY3_MAJOR.${PY3_MINOR}m
