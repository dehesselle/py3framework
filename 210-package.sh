...
relocate_dependency @loader_path/../../../Libraries/libreadline.8.dylib $PY3_FRA_LIB_DIR/python3.6/lib-dynload/readline.cpython-36m-darwin.so
...
relocate_dependency @loader_path/../../../Libraries/libssl.1.1.dylib $PY3_FRA_LIB_DIR/python3.6/lib-dynload/_hashlib.cpython-36m-darwin.so
relocate_dependency @loader_path/../../../Libraries/libssl.1.1.dylib $PY3_FRA_LIB_DIR/python3.6/lib-dynload/_ssl.cpython-36m-darwin.so
...
relocate_dependency @loader_path/../../../Libraries/libcrypto.1.1.dylib $PY3_FRA_LIB_DIR/python3.6/lib-dynload/_hashlib.cpython-36m-darwin.so
relocate_dependency @loader_path/../../../Libraries/libcrypto.1.1.dylib $PY3_FRA_LIB_DIR/python3.6/lib-dynload/_ssl.cpython-36m-darwin.so
...
relocate_dependency @loader_path/../../../Libraries/liblzma.5.dylib $PY3_FRA_LIB_DIR/python3.6/lib-dynload/_lzma.cpython-36m-darwin.so
...
relocate_dependency @loader_path/../../../Libraries/libz.1.dylib $PY3_FRA_LIB_DIR/python3.6/lib-dynload/zlib.cpython-36m-darwin.so
relocate_dependency @loader_path/../../../Libraries/libz.1.dylib $PY3_FRA_LIB_DIR/python3.6/lib-dynload/binascii.cpython-36m-darwin.so
...
relocate_dependency @loader_path/../../../../../Libraries/libxml2.2.dylib $PY3_FRA_LIB_DIR/python3.6/site-packages/libxml2mod.so
relocate_dependency @loader_path/../../../../../Libraries/libz.1.dylib $PY3_FRA_LIB_DIR/python3.6/site-packages/libxml2mod.so
relocate_dependency @loader_path/../../../../../Libraries/liblzma.5.dylib $PY3_FRA_LIB_DIR/python3.6/site-packages/libxml2mod.so
relocate_dependency @loader_path/../../../../../Libraries/libintl.8.dylib $PY3_FRA_LIB_DIR/python3.6/site-packages/libxml2mod.so
relocate_dependency @loader_path/../../../../../Libraries/libiconv.2.dylib $PY3_FRA_LIB_DIR/python3.6/site-packages/libxml2mod.so
relocate_dependency @loader_path/../../../Python $PY3_FRA_LIB_DIR/python3.6/site-packages/libxml2mod.so
...
relocate_dependency @executable_path/../Python $PY3_FRA_BIN_DIR/python3.6
relocate_dependency @executable_path/../Python $PY3_FRA_BIN_DIR/python3.6m
